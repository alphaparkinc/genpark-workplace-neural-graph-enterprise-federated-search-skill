# genpark-workplace-neural-graph-enterprise-federated-search-skill
...
> **GenPark AI Agent Skill** -- Workplace neural graph and federated enterprise search engine (Glean style)
